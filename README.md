# R A N D B A T S D A M A G E C A L C ~
[![Build Status](https://travis-ci.org/randbatscalc/randbatscalc.github.io.svg?branch=master)](https://travis-ci.org/randbatscalc/randbatscalc.github.io)

Pokemon Damage Calculator for Gen 7 Random Battles, preloaded with sets for all available Pokemon. Based on the work by Jake White ([@squirrelboyvgc](https://twitter.com/squirrelboyvgc)), cant say ([@jakecantsay](https://twitter.com/jakecantsay)) and LegoFigure11 ([@LegoFigure11](https://twitter.com/LegoFigure11)).
...
The calculator also adds manual auras and aura break, weathers, and terrains.
...
* [Calc](https://randbatscalc.github.io/)
